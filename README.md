...
**there is also a JSSImporter recipe too, but you will need to edit the smart group to remove the build number from the application version becuase I hvae not found away around haing it inserted (thanks OpenVPN...)**
